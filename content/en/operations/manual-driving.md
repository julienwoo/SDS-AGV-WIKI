...
2. **Check the surrounding area** is clear before moving.
3. **Press the enable button to the middle position** and use the joystick to drive the AGV slowly and deliberately.
4. **Keep line of sight** with the AGV at all times while driving manually.
5. **Do not handle any cargo carrier that hasn't been confirmed** by your project — overloading or handling unstable cargo is prohibited by the manual, and the operator is responsible for any resulting risk.
6. **Stop and park** the AGV in a safe, designated location once done.
7. **Switch back to Auto mode** when manual driving is complete, if the AGV should resume automatic tasks.
...
If the AGV does not respond to the handheld device even with the enable button correctly held, record what you saw and hand off per the Escalation note below.
