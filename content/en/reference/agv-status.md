...
Looking at this from the RCS screen instead? RCS has its own, separate **Vehicle Status** and **Operating Mode** fields — see [RCS Status Definitions](rcs-ui-basics.md), sections 1 and 2. The two vocabularies don't map one-to-one.
