...
Check whether RCS has actually dispatched an AGV to it at all (RCS-side), and whether that AGV shows a communication or motion alarm (AGV-side) — check [Alarm Codes](../reference/alarm-codes.md) for a matching code. If nothing shows anything wrong, this is likely an RCS/WMS coordination issue rather than something fixable at the vehicle.
